...
<div class="btn-toolbar">
    <button class="btn btn-primary"><i class="icon-plus"></i><a href="${pageContext.request.contextPath }/manager/newruku.jsp"> 新入库单</a></button>
  <div class="btn-group">
  </div>
</div>
<div class="well">
    <table class="table">
      ...
      <tbody>
      <c:forEach items="${rukuList }" var="ruku" varStatus="status">
        <tr>
          ...
          <td>${ruku.ckName }</td>
          <td>
              <a href="tomodify?id=${ruku.id }"><i class="icon-pencil"></i></a>
              <a href="#myModal" role="button" data-toggle="modal" onclick="tomyModal('${ruku.id}')"><i class="icon-remove"></i></a>
          </td>
        </tr>
        </c:forEach>
      </tbody>
...
<div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
        <p class="error-text"><i class="icon-warning-sign modal-icon"></i>确定要删除这一条入库单吗?</p>
    </div>
    ...
    <script type="text/javascript">
    	...
    	function tomyModal(id){
    		...
    		$(".btn-danger").on("click",function(){
    			window.location.href = '${pageContext.request.contextPath }' + "/ruku/removeRuKu?id=" + id;
