...
<div class="well">
    ...
    <form id="tab">
        ...
        <label>价格</label>
        <input type="text" id="outPrice" class="input-xlarge">
        <label>数量</label>
        <input type="text" id="outNum" class="input-xlarge">
        <label>客户</label>
        <select name="DropDownTimezone" id="DropDownTimezone" class="input-xlarge khName">
        ...
        <select name="DropDownTimezone" id="DropDownTimezone" class="input-xlarge sta">
          ...
          <option class="status">已出库</option>
    	</select>
        <label>其余价格</label>
