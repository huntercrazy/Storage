...
<div class="well">
    ...
    <form id="tab">
       <label>名称</label>
       	<input type="hidden" id="khid" value="${kehu.id }">
        <input type="text" id="khName" class="input-xlarge" value="${kehu.khName }">
        <label>地址</label>
        <input type="text" id="khAddress" class="input-xlarge" value="${kehu.khAddress }">
        <label>联系方式</label>
        <input type="text" id="khPhone" class="input-xlarge" value="${kehu.khPhone }">
        <label>备注</label>
        <input type="text" id="content" class="input-xlarge" value="${kehu.content }">
    </form>
      </div>
    ...
    <script type="text/javascript">
    		...
    		$(".btn-primary").on("click", function(){
	    		...
	    		var khAddress = $("#khAddress").val();
	    		var khPhone = $("#khPhone").val();
	    		var content = $("#content").val();
	    		window.location.href = '${pageContext.request.contextPath }' + "/kehu/saveKeHu?khName=" + khName + "&khAddress=" + khAddress + "&khPhone=" + khPhone + "&content=" + content + "&id=" + id;
    		});
