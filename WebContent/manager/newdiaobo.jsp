...
<div class="well">
    ...
    <form id="tab">
        ...
        <label>数量</label>
        <input type="text" id="dbNum" class="input-xlarge">
        <label>原仓库</label>
        <select name="DropDownTimezone" id="DropDownTimezone" class="input-xlarge oldckName">
        	<!--<c:forEach items="${ckNameList }" var="ckName">
          		<option id="oldCkName">${ckName.ckName }</option>
          	</c:forEach>-->
    	</select>
        <label>新仓库</label>
        <select name="DropDownTimezone" id="DropDownTimezone" class="input-xlarge newckName">
          	<!--<c:forEach items="${ckNameList }" var="ckName">
          		<option id="newCkName">${ckName.ckName }</option>
          	</c:forEach>-->
    	</select>
        <label>其余价格</label>
