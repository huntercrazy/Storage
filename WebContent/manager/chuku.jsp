...
<div class="btn-toolbar">
    <button class="btn btn-primary"><i class="icon-plus"></i><a href="${pageContext.request.contextPath }/manager/newchuku.jsp"> 新出库单</a></button>
  <div class="btn-group">
  </div>
</div>
<div class="well">
    <table class="table">
      ...
      <tbody>
      	<c:forEach items="${chukuList }" var="chuku" varStatus="status">
        <tr>
          ...
          <td>${chuku.ckName }</td>
          <td>
              <a href="tomodify?id=${chuku.id }"><i class="icon-pencil"></i></a>
              <a href="#myModal" role="button" data-toggle="modal" onclick="tomyModal('${chuku.id}')"><i class="icon-remove"></i></a>
          </td>
        </tr>
...
<div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
        <p class="error-text"><i class="icon-warning-sign modal-icon"></i>确定要删除这一条出库单吗?</p>
    </div>
    ...
    <script type="text/javascript">
    	function tomyModal(id){
    		$(".btn-danger").on("click",function(){
    			window.location.href = '${pageContext.request.contextPath }' + "/chuku/removeChuKu?id=" + id;
    		})
    	}
    </script>
