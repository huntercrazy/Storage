...
<div class="well">
    ...
    <form id="tab">
        <label>名称</label>
        <input type="text" id="gyName" class="input-xlarge">
        <label>地址</label>
        <input type="text" id="gyAddress" class="input-xlarge">
        <label>联系方式</label>
        <input type="text" id="gyPhone" class="input-xlarge">
        <label>备注</label>
    ...
    <script type="text/javascript">
    		...
    		$(".btn-primary").on("click", function(){
	    		...
	    		window.location.href = '${pageContext.request.contextPath }' + "/gongying/saveGongYing?gyName=" + gyName + "&gyAddress=" + gyAddress + "&gyPhone=" + gyPhone + "&content=" + content;
    		});
