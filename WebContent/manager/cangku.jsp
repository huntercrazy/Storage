...
<div class="btn-toolbar">
    <button class="btn btn-primary"><i class="icon-plus"></i><a href="${pageContext.request.contextPath }/manager/newcangku.jsp"> 新仓库</a></button>
  <div class="btn-group">
  </div>
</div>
<div class="well">
    <table class="table">
      ...
      <tbody>
      	<c:forEach items="${cangkuList }" var="cangku" varStatus="status">
	        <tr>
	          <td>${status.count }<input type="hidden" value="${cangku.id }"/></td>
	          <td>${cangku.ckName }</td>
	          <td>${cangku.userName }</td>
	          <td>${cangku.ckAddress }</td>
	          <td>${cangku.content }</td>
	          <td>
	              <a href='tomodify?id=${cangku.id }'><i class="icon-pencil"></i></a>
