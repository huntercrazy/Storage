...
<div class="well">
    ...
    <form id="tab">
        <label>商品名称</label>
        <input type="text" id="goodsName" class="input-xlarge" value="${shunhuai.goodsName }">
        <label>操作员</label>
        <input type="text" id="userName" class="input-xlarge" value="${shunhuai.userName }">
        <label>数量</label>
        <input type="text" id="breakNum" class="input-xlarge" value="${shunhuai.breakNum }">
        <label>仓库</label>
        <input type="text" id="ckName" class="input-xlarge" value="${shunhuai.ckName }">
        <label>备注</label>
        <input type="text" id="content" class="input-xlarge" value="${shunhuai.content }">
    </form>
      </div>
    ...
    $(".btn-primary").on("click", function(){
    	window.location.href = '${pageContext.request.contextPath }/shunhuai/shunhuailist'
    });
    </script>
    <!-- <script type="text/javascript">
		...
		$(".btn-primary").on("click", function(){
    		...
    		if(goodsName==null || userName==null || breakNum==null || ckName==null){
    			alert("数据不完整,请补充")
    		}else{
    			window.location.href = '${pageContext.request.contextPath }' + "/shunhuai/saveShunHuai?goodsName=" + goodsName + "&userName=" + userName + "&breakNum=" + breakNum + "&ckName=" + ckName + "&content=" + content; 
    		}
    	});
    </script> -->
</html>
