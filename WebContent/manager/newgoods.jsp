...
<div class="well">
    ...
    <form id="tab">
        <label>商品名称</label>
        <input type="text" id="goodsName" class="input-xlarge">
        <label>类型</label>
        <input type="text" id="goodsType" class="input-xlarge">
        <label>计件方式</label>
        <input type="text" id="goodsKind" class="input-xlarge">
        <label>备注</label>
    ...
    <script type="text/javascript">
    		...
    		$(".btn-primary").on("click", function(){
	    		...
	    		window.location.href = '${pageContext.request.contextPath }' + "/goods/saveGoods?goodsName=" + goodsName + "&goodsType=" + goodsType + "&goodsKind=" + goodsKind + "&content=" + content;
    		});
