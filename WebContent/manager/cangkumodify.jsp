...
<html lang="en">
  ...
  <!--<![endif]-->
        ...
        <div class="row-fluid">
            <div class="span3">
                ...
                <ul id="settings-menu" class="nav nav-list collapse in">
                  <li class="active"><a href="${pageContext.request.contextPath }/cangku/cangkulist">仓库</a></li>
    ...
    <button class="btn btn-primary"><i class="icon-save"></i> 确认修改</button>
  	<div class="btn-group">
  </div>
</div>
<div class="well">
    ...
    <form id="tab">
        <label>名称</label>
        <input type="hidden" id="ckid" value="${cangku.id }">
        <input type="text" id="ckName" class="input-xlarge" name="ckName" value="${cangku.ckName }">
        <label>管理员</label>
        <input type="text" id="userName" class="input-xlarge" name="userName" value="${cangku.userName }">
        <label>地址</label>
        <input type="text" id="ckAddress" class="input-xlarge" name="ckAddress" readonly="readonly" value="${cangku.ckAddress }">
        <label>别称</label>
        <input type="text" id="content" class="input-xlarge" name="content" value="${cangku.content }">
 ...
 //   	$(document).ready(function(){
  ...
  //  		$.ajax({
  //  			url: '${pageContext.request.contextPath }/user/userName',
   // 			type: 'POST',
  ...
  //  				for(var i=0;i<data.userNameArray.length;i++){
   // 					var userName = data.userNameArray[i];
  //  					$(".userName").append("<option id='userName'>"+ userName.userName +"</option>");
  //  				}
  //  			}
  //  		});
  //  	});
    	...
    	$(".btn-primary").on("click", function(){
    		...
    		+ "/cangku/modifyCangKu?ckName=" + ckName + "&userName=" + userName + "&ckAddress=" + ckAddress + "&content=" + content + "&id=" + id; 
