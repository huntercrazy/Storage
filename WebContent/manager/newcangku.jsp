...
<div class="well">
    ...
    <form id="tab">
        <label>名称</label>
        <input type="text" id="ckName" class="input-xlarge" name="ckName">
        <label>管理员</label>
        <select name="DropDownTimezone" id="DropDownTimezone" class="input-xlarge userName">

    	</select>
        <label>地址</label>
        <input type="text" id="ckAddress" class="input-xlarge" name="ckAddress">
        <label>别称</label>
        <input type="text" id="content" class="input-xlarge" name="content">
    ...
    <script type="text/javascript">
    	...
    	$(".btn-primary").on("click", function(){
    		...
    		+ "/cangku/saveCangKu?ckName=" + ckName + "&userName=" + userName + "&ckAddress=" + ckAddress + "&content=" + content; 
