...
<div class="well">
    ...
    <form id="tab">
       <label>名称</label>
        <input type="text" id="khName" class="input-xlarge">
        <label>地址</label>
        <input type="text" id="khAddress" class="input-xlarge">
        <label>联系方式</label>
        <input type="text" id="khPhone" class="input-xlarge">
        <label>备注</label>
    ...
    <script type="text/javascript">
    		...
    		$(".btn-primary").on("click", function(){
	    		...
	    		window.location.href = '${pageContext.request.contextPath }' + "/kehu/saveKeHu?khName=" + khName + "&khAddress=" + khAddress + "&khPhone=" + khPhone + "&content=" + content;
    		});
