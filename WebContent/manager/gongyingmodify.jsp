...
<div class="well">
    ...
    <form id="tab">
        <label>名称</label>
        <input type="hidden" id="gyid" value="${gongying.id }"/>
        <input type="text" id="gyName" class="input-xlarge" value="${gongying.gyName }">
        <label>地址</label>
        <input type="text" id="gyAddress" class="input-xlarge" value="${gongying.gyAddress }">
        <label>联系方式</label>
        <input type="text" id="gyPhone" class="input-xlarge" value="${gongying.gyPhone }">
        <label>备注</label>
        <input type="text" id="content" class="input-xlarge" value="${gongying.content }">
    </form>
      </div>
    ...
    <script type="text/javascript">
    		...
    		$(".btn-primary").on("click", function(){
	    		...
	    		var gyAddress = $("#gyAddress").val();
	    		var gyPhone = $("#gyPhone").val();
	    		var content = $("#content").val();
	    		window.location.href = '${pageContext.request.contextPath }' + "/gongying/modifyGongYing?gyName=" + gyName + "&gyAddress=" + gyAddress + "&gyPhone=" + gyPhone + "&content=" + content + "&id="+id;
    		});
