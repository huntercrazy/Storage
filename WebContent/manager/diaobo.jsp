...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="container-fluid">
        ...
        <div class="span9">
            <h1 class="page-title">调拨</h1>
<div class="btn-toolbar">
    <button class="btn btn-primary"><i class="icon-plus"></i><a href="${pageContext.request.contextPath }/manager/newdiaobo.jsp"> 新调拨单</a></button>
  <div class="btn-group">
  </div>
</div>
<div class="well">
    <table class="table">
      ...
      <tbody>
      <c:forEach items="${diaoboList }" var="diaobo" varStatus="status">
        <tr>
          ...
          <td>
              <a href="tomodify?id=${diaobo.id }"><i class="icon-pencil"></i></a>
            <a href="#myModal" role="button" data-toggle="modal" onclick="tomyModal('${diaobo.id}')"><i class="icon-remove"></i></a>
           <!--  <button onclick="tomyModal('${diaobo.id}')"><i class="icon-remove"></i></button> -->
          </td>
        </tr>
        </c:forEach>
      </tbody>
...
<div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
    ...
    <div class="modal-body">
        <p class="error-text"><i class="icon-warning-sign modal-icon"></i>确定要删除这一条调拨单吗?</p>
    </div>
    ...
    <script type="text/javascript">
    	...
    	function tomyModal(id){
    		...
    		$(".btn-danger").on("click",function(){
    			window.location.href = '${pageContext.request.contextPath }' + "/diaobo/removeDiaoBo?id=" + id;
