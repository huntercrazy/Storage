...
<div class="well">
    ...
    <form id="tab">
        <label>商品名称</label>
        <input type="text" id="goodsName" class="input-xlarge" value="${ruku.goodsName }" readonly="readonly">
        <label>操作员</label>
        <input type="text" id="userName" class="input-xlarge" value="${ruku.userName }" readonly="readonly">
        <label>价格</label>
        <input type="text" id="inPrice" class="input-xlarge" value="${ruku.inPrice }" readonly="readonly">
        <label>数量</label>
        <input type="text" id="inNum" class="input-xlarge" value="${ruku.inNum }" readonly="readonly">
        <label>供应商</label>
        <input type="text" id="gyName" class="input-xlarge" value="${ruku.gyName }" readonly="readonly">
        <label>仓库</label>
        <input type="text" id="ckName" class="input-xlarge" value="${ruku.ckName }" readonly="readonly">
    	<label>状态</label>
        <input type="text" id="status" class="input-xlarge" value="${ruku.status }" readonly="readonly">
        <label>其余价格</label>
        <input type="text" id="otherPrice" class="input-xlarge" value="${ruku.otherPrice }" readonly="readonly">
        <label>备注</label>
        <input type="text" id="content" class="input-xlarge" value="${ruku.content }" readonly="readonly">
    </form>
      </div>
    ...
    $(".btn-primary").on("click", function(){
    	window.location.href = '${pageContext.request.contextPath }/ruku/rukulist';
    });
    </script>
    <!-- <script type="text/javascript">
